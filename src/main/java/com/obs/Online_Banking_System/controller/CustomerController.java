...
public class CustomerController {
    ...
    public ResponseEntity<Map<String,Object>> createAccount(@RequestBody AccountCreateDto account, HttpSession session) {
    ...
    @ResponseBody
    public CustomerDto updateProfile(@PathVariable("id") Long id, @RequestBody CustomerDto customerDto,HttpSession session) {
        Long custid = id;
        if (id == null) {
            CustomerDto cust = (CustomerDto) session.getAttribute("loggedInCustomer");
